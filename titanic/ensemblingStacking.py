...
train = pd.read_csv('E:/PythonProject01/kaggle_practice/titanic/input/train.csv')
test = pd.read_csv('E:/PythonProject01/kaggle_practice/titanic/input/test.csv')
...
saveTmpTrainFile(train,'E:/PythonProject01/kaggle_practice/titanic/train_later.csv')
...
# 存储 test 文件
saveTmpFile(test,'E:/PythonProject01/kaggle_practice/titanic/test_later.csv')

# # ------------------------------------------------------------------------

# 加载我们生成的 train 和 test 文件
# # -----------注意一下哈，这个地方，需要调整一下生成的文件-------------------------------------------------------------
train_later = pd.read_csv('E:/PythonProject01/kaggle_practice/titanic/train_later.csv')
test_later = pd.read_csv('E:/PythonProject01/kaggle_practice/titanic/test_later.csv')
...
saveResult(et_oof_test,'E:/PythonProject01/kaggle_practice/titanic/result/et.csv')
saveResult(rf_oof_test,'E:/PythonProject01/kaggle_practice/titanic/result/rf.csv')
saveResult(ada_oof_test,'E:/PythonProject01/kaggle_practice/titanic/result/ada.csv')
saveResult(gb_oof_test,'E:/PythonProject01/kaggle_practice/titanic/result/gb.csv')
saveResult(svc_oof_test,'E:/PythonProject01/kaggle_practice/titanic/result/svc.csv')