...
def knnClassify(trainData, trainLabel):
    ...
    knnClf.fit(trainData, np.ravel(trainLabel))  # ravel Return a contiguous flattened array.将多维数组降为一维 https://blog.csdn.net/liuweiyuxiang/article/details/78220080
    return knnClf
